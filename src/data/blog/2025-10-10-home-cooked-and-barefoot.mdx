...
Appleton puts forward an updated thesis for this age of agentic coding. With AI coding becoming more and more capable... _and, funnily enough, she gave this talk in 2024, pre Claude Code, pre "vibe coding", in a stone-age world of _just_ Copilot and Cursor_... with AI coding becoming as powerful as it is nowadays, "large language models will create a golden age of local, home-cooked software and barefoot developers":
