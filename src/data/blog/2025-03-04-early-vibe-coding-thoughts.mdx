...
import img1 from "../../assets/images/2025/08/image-1-1024x263.png";
...
<ImageWithModal src={img1} alt="Screenshot from Cursor (AI coding tool)" title="Screenshot from Cursor (AI coding tool)" />
