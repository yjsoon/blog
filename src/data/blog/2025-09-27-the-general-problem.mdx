...
pubDatetime: 2025-09-27T00:00:00.000Z
featured: false
draft: false
...
import llmTestingArena from "../../assets/images/2025/09/llm-testing-arena.jpg";
...
1. Gemini 2.5 Flash beat the crap out of every other model I tried (the full list: Haiku 3, Pixtral, GPT 5-mini and 4o-mini, ). 4 seconds to parse the page, vs. 10+ for the next nearest model! I'd previously just done this with ChatGPT, but got bored waiting for it to make me a nice Markdown table, and this is _blazingly_ fast in comparison.
...
The GitHub repo is at [yjsoon/ynab-llm-formatter](https://github.com/yjsoon/ynab-llm-formatter). Upload one or more images, and get back a CSV in the upload format YNAB expects. That's it! Try it out, and let me know if you actually end up using it — I have no such expectations, but with AI-written personal software, that's fine.
...
<ImageWithModal
  src={llmTestingArena}
  alt="LLM testing arena... for one specific task"
